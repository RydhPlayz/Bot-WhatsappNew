...
const instagramlu = 'https://instagram.com/iam.rydh'; // Nama Instagramlu cok
const whatsapplu = '081292237269'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'Belu mAda'; // OFFICIAL GRUP LU 1
